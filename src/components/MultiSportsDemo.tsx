...
export default function MultiSportsDemo() {
    ...
    const sports: { id: Sport; label: string; icon: any; desc: string }[] = [
        ...
        { id: "handball", label: "Handball", icon: () => <img src="/handball.png" alt="Handball" className="h-[26px] w-auto object-contain grayscale opacity-80 mix-blend-multiply dark:mix-blend-screen" />, desc: "IHF Standard Court" },
