...
export default function ContactMultiSports() {
    ...
    const sports: { id: Sport; label: string; icon: any; desc: string }[] = [
        ...
        { id: "handball", label: "Handball", icon: () => <div className="w-6 h-6 flex items-center justify-center -ml-0.5"><img src="/handball.png" alt="Handball" className="w-full h-full object-contain scale-[1.5] grayscale opacity-80 mix-blend-screen" /></div>, desc: "IHF Court" },
