                    ...
                    {navLinks.map((link) => (
                        ...
                        >
                            {link.name === "PRODUCTS" ? (
                                <>
                                    <button
                                        className="text-sm md:text-sm font-bold text-white transition-all duration-300 tracking-widest uppercase flex items-center gap-1 cursor-default group-hover:text-white"
                                ...
                                <Link
                                    href={link.href}
                                    className="text-sm md:text-sm font-bold text-white transition-all duration-300 tracking-widest uppercase hover:text-white"
                                    style={{
                                        textShadow: "none"
                                    }}
                                    onMouseEnter={(e) => {
