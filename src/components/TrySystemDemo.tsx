...
export default function TrySystemDemo() {
    ...
    const sports: { id: Sport; label: string; icon: ComponentType<{ size?: number }>; desc: string }[] = [
        ...
        { id: "handball", label: "Handball", icon: () => <img src="/handball.png" alt="Handball" className="w-6 h-6 object-contain grayscale opacity-80 mix-blend-screen" />, desc: "IHF Standard Court" },
