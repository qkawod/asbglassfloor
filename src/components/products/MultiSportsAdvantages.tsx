...
const advantagesData = [
    {
        ...
        description: "ASB 스마트코트는 국제 및 프로 스포츠 공식 인증을 획득한 시스템으로, 기존 코트의 복잡한 라인으로 인한 시각적 혼란을 효과적으로 해소합니다."
    },
    {
        title: "MULTIPURPOSE (다목적 활용성)",
        description: "종목 간 간섭이 없는 쾌적한 환경을 기반으로, 터치스크린 기반 LED 라인 시스템을 통해 경기와 행사·이벤트를 하나의 공간에서 효율적으로 운영할 수 있습니다."
    },
    {
        title: "SAFE (탁월한 안전성)",
        description: "특허받은 세라믹 도트 표면 처리를 적용하여 기존 스포츠 플로어들을 능가하는 최상의 그립감과 탄성을 제공합니다.\n넘어지거나 슬라이딩 상황에서도 찰과상이 발생하지 않으며,\n우수한 탄성 구조로 충격을 효과적으로 흡수하여 무릎 등 관절 부상 위험을 줄입니다.\n또한 유해 물질이나 냄새가 전혀 없는 인체 친화적인 안전 소재로 제작되었습니다."
    },
    {
        title: "DURABLE (압도적인 내구성)",
        description: "강화 유리와 알루미늄 등 고내구성 소재로 제작되어 약 70년에 달하는 긴 기대 수명을 자랑합니다.\n장기간 사용 후에도 마모 없이 초기 품질과 성능을 안정적으로 유지합니다."
    },
    {
        title: "EASY TO MAINTAIN (유지보수의 혁신)",
        description: "외부 신발 착용, 음료 오염, 무대 장치 설치 등 다양한 상황에서도 별도의 바닥 보양 작업이 필요 없습니다.\n목재 플로어에서 요구되는 긁힘·오염 관리 및 주기적인 표면 샌딩, 왁싱과 달리, 별도의 보수 작업 없이도 안정적인 상태를 유지할 수 있으며,\n청소와 유지관리가 기존 바닥재 대비 훨씬 간편합니다."
    }
];
