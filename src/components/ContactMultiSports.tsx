...
export default function ContactMultiSports() {
    ...
    const sports: { id: Sport; label: string; icon: any; desc: string }[] = [
        ...
        { id: "handball", label: "Handball", icon: () => <img src="/handball.png" alt="Handball" className="h-[22px] w-auto flex-shrink-0 object-contain grayscale opacity-80 mix-blend-screen" />, desc: "IHF Court" },
