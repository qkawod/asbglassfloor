...
export default function MultiSportsDemo() {
    ...
    const sports: { id: Sport; label: string; icon: any; desc: string }[] = [
        ...
        { id: "handball", label: "Handball", icon: () => <div className="w-8 h-8 flex items-center justify-center -ml-1"><img src="/handball.png" alt="Handball" className="w-full h-full object-contain scale-[1.5] grayscale opacity-80 mix-blend-multiply dark:mix-blend-screen" /></div>, desc: "IHF Standard Court" },
